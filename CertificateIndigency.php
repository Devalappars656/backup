...
<body>
	<img src="Darkblue.png" style="width: 100%; height: 170px;margin-top: -2%;opacity: 0;">
			...
			<h1 style="font-size: 40px;margin-left: 29%">CERTIFICATE OF INDIGENCY</h1>
			<img src="Darkblue.png " style="margin-left: 33%;width: 30%;height: 280px; opacity: .8">
	<form action="CertificateIndingencyPrint.php" method="POST">
	<table class="Table1">
	<tr>
		<td>
...
<input type="submit" name="CertificateIndingency" style="width: 150px;height: 40px; font-size: 20px;position: absolute;top:60%;left: 43%;color: #0c3c60">
